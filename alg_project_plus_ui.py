#  =====================================================
#   Final Project Algorithm User Interface Version
#   2703
#   Collin Graham
#  =====================================================
...
## Take Inputs
period = input("Enter Task 1 Period: ")
execTm = input("Enter Task 1 Execution Time: ")
periods.append(int(period))
execTms.append(int(execTm))
a = 2
taskNum = 1

# Print options during user input stage
def print_options():
    print("============================")
    print("List of Options: ")
    print("1 - Add New Task")
    print("2 - Check RMS Compatibility")
    print("3 - Quit")
    print("============================")

# Adding all tasks to lists
while True:
    print_options()
    option = input(">> ")

    if int(option) == 3: # Quit
        quit()

    if int(option) == 2: # Start Checker
        break

    if int(option) == 1: # Add New
        print("Enter Task ", a, " Period: ")
        period = input()
        print("Enter Task ", a, " Execution Time: ")
        execTm = input()
        periods.append(int(period))
        execTms.append(int(execTm))
        a += 1
...
#   -> Rejects if Util > 100
#   -> Accepts if Util < Guarantee Level 
#   -> Passes thru if G <= Util <= 100 
